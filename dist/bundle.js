...
(() => {
  ...
  var getValidWords = (map, lettersIn, lettersOut, yellowPositions) => {
    return words_default.filter((word) => {
  ...
  var evaluateForCombo = (combo) => {
    const guessAtLine = (line) => {
      return combo[line] || "";
    };
    let map = "00000";
    let lettersIn = "";
    ...
    if (validWords.length) {
      console.log(`\u{1F3AF} ${validWords.length} for ${combo.join(" | ")}`);
